...
const firebaseConfig = {
  ...
  databaseURL: "https://swiftcast-e38f6-default-rtdb.asia-southeast1.firebasedatabase.app",
...
export { db, rtdb, ref, onValue, set, onDisconnect, collection, addDoc, onSnapshot, query, where, orderBy };
